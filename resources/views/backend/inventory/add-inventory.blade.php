...
@section('content')
        <form method="post" action="{{route('createInventory')}}" enctype="multipart/form-data" class="needs-validation" onload="multiplyBy()"
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="inv_quantity" onchange="multiplyBy()" placeholder="Enter inventory quantity"
                   name="inventory_quantity" required>
            <div class="valid-feedback">
                Looks good!
            </div>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="u_price" onchange="multiplyBy()" placeholder="Enter unit price"
                   name="inventory_unit_price" required>
            <div class="valid-feedback">
                Looks good!
            </div>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="validationCustom03" placeholder="Enter Description"
                   name="inventory_description" required>
        ...
        <div class="mb-3">
            ...
            <input name="inventory_amount" id="inventory_amount" class="form-control" readonly>
